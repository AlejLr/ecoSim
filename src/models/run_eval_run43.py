"""Long-horizon evaluation for run 43 (Protocol 2, 5 cycles).
...
Usage
-----
    python -m src.models.run_eval_run43

Run after Protocol 2 finishes:
    python -m src.models.run_training_protocol 2 5 500

Output is written to:
    src/models/results/long_horizon_evaluation/run43/
"""
